...
from banner.models import Banner, Collection, FeaturedProduct
...
def home(request):
    ...
    return render(request, 'server/home.html', {'banners': banners, 'first': first, 'second': second, 'third': third, 'fourth': fourth, 'featured_product': featured_product, 'best_sellers': best_sellers})
